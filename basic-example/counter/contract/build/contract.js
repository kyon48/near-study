...
function get_num() {
  ...
  const _args = Counter._getArgs();
  const _result = _contract.get_num(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(Counter._serialize(_result, true));
}

export { decrement, get_num, increment, reset };

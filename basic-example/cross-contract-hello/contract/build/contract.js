...
let CrossContractCall = (_dec = NearBindgen({}), _dec2 = initialize(), _dec3 = call({}), _dec4 = call({
  ...
  change_greeting({
    ...
    const promise = NearPromise.new(this.hello_account).functionCall("set_greeting", JSON.stringify({
...
function change_greeting_callback() {
  ...
  const _result = _contract.change_greeting_callback(_args);
...
function change_greeting() {
  ...
  const _args = CrossContractCall._getArgs();
  const _result = _contract.change_greeting(_args);
  CrossContractCall._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(CrossContractCall._serialize(_result, true));
}
function query_greeting_callback() {
  ...
  const _args = CrossContractCall._getArgs();
  const _result = _contract.query_greeting_callback(_args);
  CrossContractCall._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(CrossContractCall._serialize(_result, true));
}
function query_greeting() {
  ...
  const _args = CrossContractCall._getArgs();
  const _result = _contract.query_greeting(_args);
  CrossContractCall._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(CrossContractCall._serialize(_result, true));
}
function init() {
